...
<html lang="en">
  ...
  <body>
        ...
        <div class="select">
            <div class="category" style="margin-top:18px">
                <form action="" method="post"  enctype="multipart/form-data" autocomplete="off">
                    <div class="types">
                        <input type="radio" name="type" class="btn-check selectable"  value="board printing" id="btn-check-4" autocomplete="off" >
                        ...
                        <input type="radio" name="type" class="btn-check selectable" value="hard paper" id="btn-check-19" autocomplete="off">
                        <label class="btn" for="btn-check-19" style="margin-right:5px; padding:7px;width:11pc;">Book</label>

                        <input type="radio" name="type" class="btn-check selectable" value="hard paper" id="btn-check-20" autocomplete="off">
                ...
                <!-- selections from the options given below -->
                    ...
                    <div class="ap1">
                        ...
                        <input type="radio" name="types" class="btn-check b1" value="White Sheet" id="btn-check-21" autocomplete="off" >
                        <label class="btn" for="btn-check-21">White Sheet</label>

                        <input type="radio" name="types" class="btn-check b1" value="Brown Sheet" id="btn-check-22" autocomplete="off">
                        <label class="btn" for="btn-check-22">Brown Sheet</label>

                        <input type="radio" name="types" class="btn-check b1" value="Craft Paper" id="btn-check-23" autocomplete="off">
                        <label class="btn" for="btn-check-23">Craft Paper</label>

                        <input type="radio" name="types" class="btn-check b1" value="Photo Paper" id="btn-check-24" autocomplete="off">
                        ...
                        <input type="radio" name="types" class="btn-check b1" value="NewsPaper" id="btn-check-27" autocomplete="off">
                        <label class="btn" for="btn-check-27">NewsPaper</label>

                        <input type="radio" name="types" class="btn-check b1" value="Linen Paper" id="btn-check-28" autocomplete="off">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body">
                                <div class="ap1">
                                    ...
                                    <input type="radio" name="Print_Quality" class="btn-check b1" value="Medium" id="btn-check-30" autocomplete="off">
                                    <label class="btn" for="btn-check-30">Medium</label>

                                    <input type="radio" name="Print_Quality" class="btn-check b1" value="A3" id="btn-check-31" autocomplete="off">
                                ...
                                <div class="ap1">  
                                    ...
                                    <input type="radio" name="h_f" class="btn-check b1" value="include " id="btn-check-32" autocomplete="off">
                                    <label class="btn" for="btn-check-32">include </label>

                                    <input type="radio" name="h_f" class="btn-check b1" value="exclude " id="btn-check-33" autocomplete="off">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                <div class="ap1">
                                    ...
                                    <input type="radio" name="Print_Resolution" class="btn-check b1" value="High" id="btn-check-34" autocomplete="off">
                                    <label class="btn" for="btn-check-34">High</label>

                                    <input type="radio" name="Print_Resolution" class="btn-check b1" value="Medium" id="btn-check-35" autocomplete="off">
                                    <label class="btn" for="btn-check-35">Medium</label>

                                    <input type="radio" name="Print_Resolution" class="btn-check b1" value="A3" id="btn-check-36" autocomplete="off">
                                ...
                                <div class="ap1">  
                                    ...
                                    <input type="radio" name="Finishing_Options" class="btn-check b1" value="Binding" id="btn-check-37" autocomplete="off">
                                    <label class="btn" for="btn-check-37">Binding </label>

                                    <input type="radio" name="Finishing_Options" class="btn-check b1" value="Collation" id="btn-check-38" autocomplete="off">
    ...
    const radioButton3= document.getElementById('btn-check-7');
