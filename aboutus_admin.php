...
<body>
    <!-- header -->
<div class="header">
    <a href="admin_welcome.php"><img src="imgs/icon_project.png" alt="Project Icon" style="width: 150px; height: 90px;padding-top: 0px;padding-bottom:20px;"></a>
    ...
    <div class="orders" style="padding-left: 450px; padding-top: 30px;">
            <a href="" style="color: #000;text-decoration: none; margin-left:290px;"><?php echo substr($_SESSION['username'], 0, $atPosition);  ?></a>
