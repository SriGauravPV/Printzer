...
<body>
    ...
    <div class="orders" style="padding-left: 450px; padding-top: 30px;">
            <a href="index1.php" style="color: #000;text-decoration: none; margin-left:160px;">Orders</a>
        ...
        <div class="container">  
            <div class="accordion" id="accordionExample">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body"> <!-- information1 -->
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                    <div class="card-body"> <!-- information2 --> 
                    2. Services Offered:
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                    <div class="card-body"> <!-- information 3 -->
