...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO `printzer`.`information` (`type`,`filename`, `size`, `borders`, `type_print`, `Qty`, `prod`, `Package_type`, `no_sheet`) 
              VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)";
    ...
    mysqli_stmt_bind_param($stmt, 'sssssssss', $type,$filename, $size, $borders, $type_print, $Qty, $prod, $Package_type, $no_sheet);
...
<head>
    ...
    <link rel="icon" href="imgs/icon_project.jpg"> 
...
<body>
    ...
    <a href="index.php"><img src="imgs/icon_project.png" alt="Project Icon" style="width: 150px; height: 90px;padding-top: 0px;padding-bottom:20px;"></a>
        ...
        <div class="orders">
            <a href="index1.php" class="a" style="color: #000;text-decoration: none; margin-left:300px;">Orders</a>
            <a href="login.php" style="color: #000;text-decoration: none; margin-left:20px;">Login</a>
            <a href="signup.php" style="color: #000;text-decoration: none; margin-left:20px;">Signup</a>
        ...
        <div class="category" style="margin-top:18px">
            <form action="" method="post"  enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="ap3">
                    ...
                    <input type="radio" name="type_print" class="btn-check b3" value="Color Print" id="btn-check-15" autocomplete="off">
                    <label class="btn" for="btn-check-15">Color Print</label>

                    <input type="radio" name="type_print" class="btn-check b3" value="Black and White Print" id="btn-check-16" autocomplete="off">
    ...
    document.getElementById("button-submit").addEventListener("click", function(event) {
        ...
        */
        if (!isLoggedIn) {
            ...
            alert("Please log in first before you Use our website."); // Show alert
        }
    });
    </script>
